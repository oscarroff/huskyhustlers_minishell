...
BUILTINS_F	= bexit.c cd.c echo.c env.c export.c export_quicksort.c pwd.c \
			  unset.c
DEBUGGING_F	= debugging.c debug_printing.c print_cmd_tab.c token_printing.c
...
DEBUGGING	= $(addprefix $(DEBUGGING_D)/, $(DEBUGGING_F))
...
SOURCES		= src/main.c $(BUILTINS) $(DEBUGGING) $(ENVP) $(EXECUTOR) \
			  $(HEREDOC) $(LEXER) $(PARSER) $(UTILS)

# HEADER FILES
HEADER_F	= debugging.h execution.h messages.h minishell.h parsing.h \
			  signals.h
